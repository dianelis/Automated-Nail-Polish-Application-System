...
The uploaded Kaggle notebook defines a PyTorch U-Net for binary nail segmentation. `vision.py` mirrors that model structure so you can train on your laptop, save the weights, copy them to the Raspberry Pi, and run inference.
